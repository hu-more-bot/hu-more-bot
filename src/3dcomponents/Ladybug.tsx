...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <a.group
      ...
      scale={scale.to(s => [s, s, s])} // Properly apply animated scale
      onClick={toggle}
    >
      ...
      <a.mesh 
        ...
        position={position.to(s => [0, 0, s*2])} // Fix position animation
      />
      ...
      {/* Animate the base mesh position with correct negation */}
      <a.mesh 
        geometry={nodes.base.geometry} 
        material={materials['0.231373_0.380392_0.705882_0.000000_0.000000']} 
        position={position.to(s => [0, 0, -s])} // Properly negate position
      />
    </a.group>
  )
}
